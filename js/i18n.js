...
const TRANSLATIONS = {
  ...
  "nav.cta.quote": {en:"Request a Quote", ar:"اطلب عرض سعر"},
  ...
  "home.lede": {en:"Aurora is a wholesale kitchen for coffee shops, restaurants and gelato shops that want real Italian-style ice cream without running their own production. Twenty-two flavors, three tiers, one dependable tub.", ar:"أورورا مطبخ جملة لمحلات القهوة والمطاعم ومحلات الجيلاتو التي تريد آيس كريم إيطالي حقيقي دون تشغيل خط إنتاج خاص بها. اثنتان وعشرون نكهة، ثلاث فئات، ووعاء واحد يمكن الاعتماد عليه."},
  ...
  "home.tier.special.desc": {en:"Nine standout flavors, from Snickers and Twix to Pistachio and Arabic Mesteka — built to be noticed on a menu board.", ar:"تسع نكهات مميزة، من سنيكرز وتويكس إلى الفستق والمستكة العربية — مصممة لتلفت الأنظار على قائمة الطعام."},
  "home.tier.request.title": {en:"Upon Request", ar:"حسب الطلب"},
  "home.tier.request.desc": {en:"Ten more flavors — Knafeh, Saffron, Turkish Delight and others — made to order for menus that want something unique.", ar:"عشر نكهات إضافية — كنافة وزعفران وراحة تركية وغيرها — تُصنع حسب الطلب لقوائم الطعام التي تريد شيئًا مميزًا."},
  "home.see_all": {en:"See all 22 flavors", ar:"شاهد جميع النكهات الـ 22"},
  ...
  "home.cta2.h2": {en:"Ready to stock Aurora in your case?", ar:"هل أنت مستعد لعرض منتجات أورورا؟"},
  "home.cta2.p": {en:"Tell us what you need — we'll get back to you with pricing and availability.", ar:"أخبرنا بما تحتاجه — وسنعاود التواصل معك بالسعر والتوفر."},
  ...
  "flavors.h1": {en:"22 flavors. Three tiers. One tub size.", ar:"22 نكهة. ثلاث فئات. حجم وعاء واحد."},
  "flavors.p": {en:"Every flavor ships in a 5-liter wholesale tub, churned to the same standard whether it's your first order or your fiftieth. Pricing is quoted per business, based on flavor mix and volume — request a quote and we'll send current rates.", ar:"تُشحن كل نكهة في وعاء جملة سعة 5 لتر، بنفس المعيار سواء كان طلبك الأول أو الخمسين. يُحدد السعر لكل شركة بناءً على مزيج النكهات والكمية — اطلب عرض سعر وسنرسل لك الأسعار الحالية."},
  ...
  "flavors.note.request": {en:"Not on the standard list? These (and more) can be made to order — ask us when requesting your quote.", ar:"ليست ضمن القائمة القياسية؟ يمكن صنع هذه (وغيرها) حسب الطلب — اسألنا عند طلب عرض السعر."},
  ...
  "order.h1": {en:"Pick your flavors, we'll take it from there.", ar:"اختر نكهاتك، وسنتولى الباقي."},
  ...
  "home.eyebrow.brand": {en:"Artisan Gelato · Amman, Jordan", ar:"جيلاتو حِرَفي · عمّان، الأردن"},
  ...
  "about.hero.p": {en:"Aurora Ice Cream is a premium artisan gelato brand established in 2026, inspired by the beauty of authentic Italian gelato and crafted with a modern vision. We believe every scoop should be an experience — bringing together exceptional ingredients, creative flavors, and unforgettable moments.", ar:"أورورا آيس كريم علامة جيلاتو حِرَفية فاخرة تأسست عام 2026، مستوحاة من جمال الجيلاتو الإيطالي الأصيل ومصمَّمة برؤية عصرية. نؤمن بأن كل مغرفة يجب أن تكون تجربة — تجمع بين مكونات استثنائية ونكهات مبتكرة ولحظات لا تُنسى."},
  ...
  "about.story.p1": {en:"Aurora was born from a simple dream: to redefine the ice cream experience. Inspired by the craftsmanship of traditional Italian gelato and the rich flavors of the Middle East, Aurora was founded in 2026 with a vision to create more than just desserts — we create moments of happiness.", ar:"وُلدت أورورا من حلم بسيط: إعادة تعريف تجربة الآيس كريم. مستوحاة من حرفية الجيلاتو الإيطالي التقليدي ونكهات الشرق الأوسط الغنية، تأسست أورورا عام 2026 برؤية لصنع أكثر من مجرد حلويات — نحن نصنع لحظات سعادة."},
  "about.story.p2": {en:"Our journey began with a passion for combining authentic recipes, premium ingredients, and innovative flavor combinations. Every recipe is carefully developed to deliver a perfectly balanced texture, rich taste, and memorable experience. Today, Aurora continues to craft artisan gelato that celebrates creativity, quality, and the joy of sharing life's sweetest moments.", ar:"بدأت رحلتنا بشغف للجمع بين الوصفات الأصيلة والمكونات الفاخرة ومزيجات النكهات المبتكرة. تُطوَّر كل وصفة بعناية لتقديم قوام متوازن تمامًا، وطعم غني، وتجربة لا تُنسى. واليوم، تواصل أورورا صناعة جيلاتو حِرَفي يحتفي بالإبداع والجودة وفرحة مشاركة أحلى لحظات الحياة."},
  ...
  "about.mission.desc": {en:"To create premium artisan gelato that brings people together through exceptional quality, innovative flavors, and memorable experiences.", ar:"صنع جيلاتو حِرَفي فاخر يجمع الناس من خلال جودة استثنائية ونكهات مبتكرة وتجارب لا تُنسى."},
  ...
  "about.diff.1": {en:"Authentic artisan gelato", ar:"جيلاتو حِرَفي أصيل"},
