...
const FLAVOR_CATALOG = {
  ...
  dietketo: [
    { code: "DK-01", icon: "cl-01-vanilla-new", en: "Vanilla — Diet & Keto", ar: "فانيلا (دايت وكيتو)" },
    { code: "DK-02", icon: "cl-02-chocolate-new", en: "Chocolate — Diet & Keto", ar: "شوكولاتة (دايت وكيتو)" },
    { code: "DK-03", icon: "sp-09-raspberry", en: "Sorbet — Diet & Keto", ar: "سوربيه (دايت وكيتو)" },
  ]
};
